...
const styles = StyleSheet.create({
  ...
  btnNewText: { color: '#fff', fontSize: scaleFont(12), fontWeight: 'bold' },
  searchBox: {
  ...
  nombre: { fontSize: scaleFont(15), fontWeight: 'bold', color: '#0f172a', marginBottom: 6 },
  badgeRow: { flexDirection: 'row', gap: 6, flexWrap: 'wrap' },
  catBadge: { borderRadius: 6, paddingHorizontal: scaleFont(8), paddingVertical: 2 },
  catBadgeText: { color: '#fff', fontSize: scaleFont(11), fontWeight: '700' },
  statusBadge: { borderRadius: 6, paddingHorizontal: scaleFont(8), paddingVertical: 2 },
  badgeActive: { backgroundColor: '#dcfce7' },
  badgeInactive: { backgroundColor: '#fee2e2' },
  statusBadgeText: { fontSize: scaleFont(11), fontWeight: '700' },
  ...
  specsRow: {
    ...
    paddingTop: scaleFont(10), borderTopWidth: 1, borderTopColor: '#f1f5f9', gap: 12,
  },
  specItem: { flexDirection: 'row', alignItems: 'center', gap: 4 },
  specIcon: { fontSize: scaleFont(14) },
  specLabel: { fontSize: scaleFont(12), color: '#64748b', fontWeight: '500' },
  empty: { textAlign: 'center', marginTop: 40, color: '#94a3b8', fontSize: scaleFont(14) },
});
